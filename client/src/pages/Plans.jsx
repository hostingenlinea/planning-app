...
import CreateServiceModal from '../components/CreateServiceModal'; // Aquí usamos el archivo que ya tienes
...
const Plans = () => {
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map((service) => {
            ...
            if (service.type === 'Jovenes') bgClass = 'bg-orange-500';
            if (service.type === 'Ensayo') bgClass = 'bg-purple-600';
            if (service.type === 'Noche ADN') bgClass = 'bg-black';
            ...
            return (
              ...
              >
                <div className="flex h-full">
                  <div className={`w-24 flex flex-col items-center justify-center text-white p-2 text-center ${bgClass}`}>
      ...
      {/* Aquí llamamos al modal que ya creaste */}
      <CreateServiceModal 
        isOpen={isModalOpen} 
